...
import { BRIDE_EVENT_INFO, COUPLE_INFO, EVENT_INFO, GROOM_EVENT_INFO } from '../constants/weddingInfo';
        ...
        <div className="section-wrapper full-width full-height p-relative">
          ...
          <div className="section-container full-height p-relative">
            ...
            <div className="com-text-block p-absolute animation hero-time">
              <div className="text-block">
                <h2 className="text-block-css full-width">{eventTimeInfo.HERO_TIME_DISPLAY}<br /></h2>
              </div>
            </div>
            ...
            {isHeroImageOpen && (
              <div className="image-modal-backdrop" onClick={() => setIsHeroImageOpen(false)}>
                <div className="image-modal-content" onClick={(e) => e.stopPropagation()}>
                  ...
                  <img src={HERO_IMAGE_URL} alt="Ảnh thiệp cưới phóng to" className="image-modal-img" />
                </div>
              </div>
            )}
          </div>
