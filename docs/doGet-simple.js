/**
 * VERSION ĐƠN GIẢN - CHỈ CẦN THAY ĐỔI SPREADSHEET_ID VÀ SHEET_NAME
 * 
 * Nếu bạn đã có SPREADSHEET_ID và SHEET_NAME được định nghĩa ở đầu file,
 * thì chỉ cần copy phần function doGet() bên dưới
 */

function doGet(e) {
  try {
    // Mở Google Sheets (sử dụng SPREADSHEET_ID và SHEET_NAME đã có)
    ...
    if (messageIndex === -1) {
      return createResponse({
        success: false,
        message: 'Không tìm thấy cột "Lời chúc"',
        messages: []
      });
    }
